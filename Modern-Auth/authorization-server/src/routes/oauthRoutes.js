...
// Login page
router.get('/authorize', catchAsync(authController.showLogin));
router.post('/login', catchAsync(authController.handleLogin));

// Registration page
router.get('/register', catchAsync(authController.showRegister));
router.post('/register', catchAsync(authController.handleRegister));

// Handling consent form POST
router.post('/consent', catchAsync(authController.handleConsent));

// Handling the token exchange POST
router.post('/token', catchAsync(tokenController.handleToken));
...
router.delete('/api/delete-account', catchAsync(async (req, res) => {
